...
public class MySQLStorage {
    ...
    public MySQLStorage(SXBans plugin) {
        this.plugin = plugin;
    ...
    public void savePunishment(Punishment punishment) {
        String sql = "INSERT INTO punishments (id, player_uuid, player_name, ip_address, type, reason, " +
                ...
                "reason = VALUES(reason), duration = VALUES(duration), end_time = VALUES(end_time), " +
                "status = VALUES(status), remover_uuid = VALUES(remover_uuid), " +
                "remover_name = VALUES(remover_name), removed_time = VALUES(removed_time), " +
                "remove_reason = VALUES(remove_reason), updated_at = VALUES(updated_at), " +
                "server_name = VALUES(server_name), world_name = VALUES(world_name), " +
                "ip_country = VALUES(ip_country), ip_city = VALUES(ip_city), " +
                "client_version = VALUES(client_version), client_brand = VALUES(client_brand)";
    ...
    public void saveIPData(IPData ipData) {
        String sql = "INSERT INTO ip_data (ip_address, country, city, isp, hostname, first_seen, " +
                ...
                "isp = VALUES(isp), hostname = VALUES(hostname), last_seen = VALUES(last_seen), " +
                "total_logins = total_logins + 1, total_punishments = VALUES(total_punishments), " +
